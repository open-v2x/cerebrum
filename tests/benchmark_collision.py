...
def draw_collision_fps(x, y):
    ...
    plt.title("Collision Prediction Algorithm Benchmark", fontsize=15)
...
def draw_benchmark_fps(context_frames1, current_frame1, last_timestamp):
    ...
    while len(context_frames1) < max_id_amount:
        ...
        if len(context_frames1) % benchmark_point_interval == 0:
            print('++++++++++++', len(context_frames1))
            benchmark_point_x.append(len(context_frames1))
            benchmark_point_y.append(
                calc_collision_eff_fps(context_frames1, current_frame1,
                                       last_timestamp))
...
plt.savefig('collision_algo_benchmark_fps_' + str(max_id_amount) + '.png',
            dpi=300)
plt.savefig('collision_algo_benchmark_fps_' + str(max_id_amount) + '.svg')
...
def draw_benchmark_time(context_frames2, current_frame2, last_timestamp):
    ...
    while len(context_frames2) < max_id_amount:
        ...
        if len(context_frames2) % benchmark_point_interval == 0:
            print('++++++++++++', len(context_frames2))
            benchmark_point_x.append(len(context_frames2))
            benchmark_point_y.append(
                calc_collision_eff_time(context_frames2, current_frame2,
                                        last_timestamp))
    plt.figure(figsize=(8, 5))
...
plt.savefig('collision_algo_benchmark_time_' + str(max_id_amount) + '.png',
            dpi=300)
plt.savefig('collision_algo_benchmark_time_' + str(max_id_amount) + '.svg')
